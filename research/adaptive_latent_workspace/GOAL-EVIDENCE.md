...
problem. E1–E28 are complete. E29 is running and is excluded from conclusions
until its complete result and state audit exist.
...
| General reasoning | E14–E16 model/search separation; E27 trained graph results; E28 frozen-depth intervention | Not established. Familiar-length chain competence fails larger-graph transfer; more recurrence can damage correct answers. The graph core is not a trained language or multimodal reasoning system. |
