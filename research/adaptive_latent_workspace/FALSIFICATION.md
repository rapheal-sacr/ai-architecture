...
| H4 | Learned dynamics support efficient long-horizon planning | RUNNING_E14 | Neural transition/reward model and learned-only action search passed preflight; scored changing-dynamics control and compounding-error probes are running |
